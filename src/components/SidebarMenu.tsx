...
export function SidebarMenu({ isOpen = true, onClose }: SidebarMenuProps) {
  ...
  return (
    <>
      ...
      <aside className="hidden md:flex md:flex-col fixed left-0 top-0 h-screen w-64 bg-gradient-to-b from-white to-[#f5f5f5] border-r border-[#afafaf]/20 shadow-lg z-40">
        {/* Header Sidebar */}
        ...
        <Link to="/profilo" className="p-4 border-b border-[#afafaf]/20 hover:bg-[#f5f5f5] transition-colors">
          <div className="flex items-center gap-3 p-3 bg-gradient-to-r from-[#ff0000]/5 to-transparent rounded-xl">
            <div className="w-10 h-10 bg-gradient-to-br from-[#ff0000] to-[#cc0000] rounded-full flex items-center justify-center shadow-md">
        ...
        {isOpen && (
          <>
            ...
            <motion.aside
              ...
              className="md:hidden fixed left-0 top-0 h-screen w-80 max-w-[85vw] bg-gradient-to-b from-white to-[#f5f5f5] shadow-2xl z-50 flex flex-col overflow-y-auto"
            >
